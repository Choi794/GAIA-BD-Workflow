...
setwd("F:/GAIA_datapaper/final_code/hexlevel")
...
setwd("E:/GAIA_BD/All_data2/hex0.5")
...
fwrite(
  hex_centroid_table,
  "F:/GAIA_datapaper/hex0.5_centroid_coordinates.csv"
)
...
centroid <- fread("F:/GAIA_datapaper/hex0.5_centroid_coordinates.csv")
bio <- fread("F:/GAIA_datapaper/Incidence3/NumObs/hexIDlevel_biodiversity.csv")
