...
#
# The workflow is shown using a sample of the North America dataset as an example.
...
tree <- fread("Plot_level_FIA_sample.csv")
...
fwrite(
  tree_outliers,
  "data/output/Outliers_Plot_level_FIA.csv"
)

fwrite(
  tree_clean,
  "data/output/Cleaned_Outliers_Plot_level_FIA.csv"
)
...
tree_level <- fread(
  "data/intput/Tree_level_FIA_sample.csv"
)
...
fwrite(
  tree_level_clean,
  "data/output/Cleaned_Outliers_tree_level_FIA.csv"
)

# Export removed tree-level outlier records
fwrite(
  tree_level_outliers,
  "data/output/Outliers/Outliers_treelevel_FIA.csv"
)
