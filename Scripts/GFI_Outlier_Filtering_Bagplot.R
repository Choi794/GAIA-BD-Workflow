...
fwrite(
  tree_outliers,
  "data/output/Outliers_Plot_level_FIA3.csv"
)

fwrite(
  tree_clean,
  "data/output/Cleaned_Outliers_Plot_level_FIA3.csv"
)
...
fwrite(
  tree_level_clean,
  "data/output/Cleaned_Outliers_tree_level_FIA3.csv"
)

# Export removed tree-level outlier records
fwrite(
  tree_level_outliers,
  "data/output/Outliers_treelevel_FIA3.csv"
)
